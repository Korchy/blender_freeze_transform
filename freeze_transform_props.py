...
class FREEZE_TRANSFORM_transform_matrix(PropertyGroup):
...
def register():
    register_class(FREEZE_TRANSFORM_transform_matrix)
    Object.freeze_transform_matrix = PointerProperty(
        type=FREEZE_TRANSFORM_transform_matrix
    )
    Object.freeze_transform_flag = BoolProperty(
        default=False
    )


def unregister():
    del Object.freeze_transform_flag
    del Object.freeze_transform_matrix
    unregister_class(FREEZE_TRANSFORM_transform_matrix)
